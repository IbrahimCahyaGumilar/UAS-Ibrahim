        ...
        <div class="grid grid-cols-1 grid-rows-1 pt-[110px]">
            <div class="flex flex-col lg:flex-row justify-center items-center gap-6 bg-white rounded-lg h-30 py-10">
                <div>
                    ...
                    <p class="mt-[24px] text-[#969696] lg:text-[14px] text-center  w-[350px] xl:w-[350px] md:w-[300px]">High School berdiri sejak
                ...
                <div>
                    ...
                    <p class="mt-[24px] text-[#969696] lg:text-[14px] text-center w-[350px] xl:w-[350px] md:w-[300px]">High School berdiri
                        sejak
                        tahun 1980 dengan nama High School 1. Sekolah yang akan membimbing
                        muridnya hingga benar</p>
                    <div class="flex justify-center">
    ...
    <section class="container mx-auto mt-[134px] bg-[#F7FBFA]">
        <div class="flex flex-col lg:flex-row">
            ...
            <div class="pl-[20px] lg:pl-[40px]">
                <p class="pt-[30px] md:pt-2 xl:pt-[60px] text-[#2F5D62] text-[10px] lg:text-[14px]" for="">Pembukaan
                    Kepala
                    Sekolah</p>
                <h1 class="font-bold text-[20px] md:text-2 xl:text-[32px] lg:w-11/12 mt-[16px]">Ucapan Kepala Sekolah HIGH SCHOOL
                </h1>
