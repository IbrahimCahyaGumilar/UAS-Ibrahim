            ...
            <div class="py-4 px-4 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form action="{{ url('update-student/'.$student->id) }}" method="POST">
                    ...
                    <div>
                        ...
                        <x-text-input id="kelas" class="block mt-1 w-full" type="text" name="kelas" :value="$student->kelas"  autofocus />
                    </div>
                    <div>
                        <x-input-label for="nilai" :value="__('Nilai')" />
                        <x-text-input id="nilai" class="block mt-1 w-full" type="text" name="nilai" :value="$student->nilai"  autofocus />
                    </div>
