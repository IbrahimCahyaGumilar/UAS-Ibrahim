    ...
    <body>
                    ...
                    <div
                        ...
                        <nav
                            ...
                            <ul class="flex flex-col lg:flex-row gap-8 md:gap-6 items-center pt-14 lg:pt-0">
                                <li class="{{ request()->is('formUser') ? 'active' : '' }}"><a href="/formUser">Home</a></li>
                                ...
                                <li class="has-child {{ request()->is('userAkademik') ? 'active' : '' }}">
                                    ...
                                    <div class="flex justify-between gap-1 items-center">
                                        <div>
                                            <a href="/userAkademik">Akademik</a>
                                        </div>
                                        <div>
                                            <span class="caret">
                                                <svg class="fill-current text-white w-5 h-5"
                                ...
                                <li class="has-child {{ request()->is('pendaftaran-siswa') ? 'active' : '' }}">
                                    <div class="flex justify-between space-x-44 lg:space-x-0 gap-1 items-center">
                                        <div>
                                            <a class="active" href="/pendaftaran-siswa">Pendaftaran</a>
                                        </div>
                                        <div>
                                            <span class="caret">
                                                <svg class="fill-current text-white w-5 h-5"
        ...
        <div class="bg-white dark:bg-gray-800 shadow">
            <div class="flex justify-between max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                ...
                {{-- <div class="font-semibold text-xl text-gray-500 hover:text-gray-800 leading-tight">
                    <a href="/add-student" class="hover:">Buat Data</a>
                </div> --}}
            </div>
    
        </div>
    
        <div class="py-14 bg-white dark:bg-gray-800 shadow">
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="py-4 px-4 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <table class="w-full border-solid border-2 border-slate-600">
                        <thead>
                            <tr class="text-center bg-primary text-white">
                                <th class="border-solid border-2 border-slate-600">GEL</th>
                                <th class="border-solid border-2 border-slate-600">WAKTU PENDAFTARAN</th>
                                <th class="border-solid border-2 border-slate-600">TEST</th>
                                <th class="border-solid border-2 border-slate-600">PENGUMUMAN</th>
                                <th class="border-solid border-2 border-slate-600">BATAS AKHIR DAFTAR ULANG</th>
                            </tr>
                        </thead>
                        <tbody class="text-center">
                            
                                <tr>
                                    <td class="border-solid border-2 border-slate-600">I</td>
                                    <td class="border-solid border-2 border-slate-600">24 Oktober 2022 - 07 Januari 2023</td>
                                    <td class="border-solid border-2 border-slate-600">08 Januari 2023</td>
                                    <td class="border-solid border-2 border-slate-600">09 Januari 2023</td>
                                    <td class="border-solid border-2 border-slate-600">06 Februari 2023</td>
                                </tr>

                                <tr>
                                    <td class="border-solid border-2 border-slate-600">II</td>
                                    <td class="border-solid border-2 border-slate-600">08 Januari 2023 - 11 Maret 2023</td>
                                    <td class="border-solid border-2 border-slate-600">12 Maret 2023</td>
                                    <td class="border-solid border-2 border-slate-600">13 Maret 2023</td>
                                    <td class="border-solid border-2 border-slate-600">01 April 2023</td>
                                </tr>

                                <tr>
                                    <td class="border-solid border-2 border-slate-600">III</td>
                                    <td class="border-solid border-2 border-slate-600">12 Maret 2023 - 13 Mei 2023</td>
                                    <td class="border-solid border-2 border-slate-600">14 Mei 2023</td>
                                    <td class="border-solid border-2 border-slate-600">15 Mei 2023</td>
                                    <td class="border-solid border-2 border-slate-600">15 Mei 2023</td>
                                </tr>

                                <tr>
                                    <td class="border-solid border-2 border-slate-600">IV</td>
                                    <td class="border-solid border-2 border-slate-600">14 Mei 2023 - 08 Juli 2023</td>
                                    <td class="border-solid border-2 border-slate-600">09 Juli 2023</td>
                                    <td class="border-solid border-2 border-slate-600">10 Juli 2023</td>
                                    <td class="border-solid border-2 border-slate-600">30 Juli 2023</td>
                                </tr>

                                <tr>
                                    <td class="border-solid border-2 border-slate-600">V</td>
                                    <td class="border-solid border-2 border-slate-600">09 Juli 2023 - 26 Agustus 2023</td>
                                    <td class="border-solid border-2 border-slate-600">27 Agustus 2023</td>
                                    <td class="border-solid border-2 border-slate-600">28 Agustus 2023</td>
                                    <td class="border-solid border-2 border-slate-600">10 September 2023</td>
                                </tr>
                    ...
                    <div class="flex justify-center items-center gap-4 py-4 mt-20">
                        <div class="bg-primary py-4 px-6 text-white hover:bg-secondary">
                            <a href="pendaftaran-siswa">DAFTAR JALUR TEST</a>
                        </div>
                        
                        <div class="bg-primary py-4 px-6 text-white hover:bg-secondary">
                            <a href="">DAFTAR JALUR NON TEST</a>
                        </div>
                    </div>
