    ...
    <header class="bg-cover bg-center bg-fixed bg-no-repeat w-full" style="background-image: url(assets/bg-nav.svg)">
        <section class="container relative px-5 xl:px-0 mx-auto w-full">
            ...
            <section class="flex justify-start lg:justify-center items-center py-[31px]">
                ...
                <div class="nav-fix flex justify-center align-center gap-32 xl:gap-32 md:gap-10 items-center text-white">
                    <div class="flex ">
                    ...
                    <nav
                        ...
                        <ul class="flex flex-col lg:flex-row gap-8 md:gap-6 items-center pt-14 lg:pt-0">
                            ...
                            <li class="has-child {{ request()->is('userPendaftaran') ? 'active' : '' }}">
                    ...
                    <div class="flex justify-center items-center gap-2">
                        ...
                        <div>
                            <button onclick="instagram()"
                                class="pc-btn1 bg-primary w-40 px-6 py-3 text-white rounded-[30px] hover:bg-secondary font-bold text-sm">
                                Hubungi Kami
                            </button>
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button
                                class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white  dark:bg-gray-800 hover:text-secondary dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
