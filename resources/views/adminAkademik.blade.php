    ...
    <body>
                    ...
                    <div
                        ...
                        <nav
                            ...
                            <ul class="flex flex-col lg:flex-row gap-8 md:gap-6 items-center pt-14 lg:pt-0">
                                <li class="{{ request()->is('formAdmin') ? 'active' : '' }}"><a href="/formAdmin">Home</a></li>
                                ...
                                <li class="has-child {{ request()->is('adminAkademik') ? 'active' : '' }}">
                                    ...
                                    <div class="flex justify-between gap-1 items-center">
                                        <div>
                                            <a class="active" href="/adminAkademik">Akademik</a>
                                        </div>
                                        <div>
                                            <span class="caret">
                                                <svg class="fill-current text-white w-5 h-5"
        ...
        <header class="container mx-auto py-12  text-black flex justify-center items-center">
            {{-- CARD 1 --}}
            <div class="container mx-auto px-4 grid grid-cols-2 grid-rows-1 lg:grid-cols-1 lg:grid-rows-2 mt-[40px] gap-4 ">
                <div class="flex flex-col lg:flex-row justify-center gap-[23px] rounded-lg">
    
                    <div class="relative">
                        <div class="{{ request()->is('adminNilai') ? 'active' : '' }}">
                            <a href="/adminNilai">
                                <img  class="w-72 opacity-1 hover:opacity-[0.6] cursor-pointer" src={{ asset('assets/buku-prakarya.png') }} alt="">
                            </a>
                    ...
                    <div class="relative">
                        <div class="">
                            <a href="/adminNilai">
                                <img class="w-72 opacity-1 hover:opacity-[0.6] cursor-pointer" src={{ asset('assets/buku-inggris.png') }} alt="">
                            </a> 
                        </div>
                    ...
                    <div class="relative">
                        <div>
                            <a href="/adminNilai">
                                <img class="w-72 opacity-1 hover:opacity-[0.6] cursor-pointer" src={{ asset('assets/buku-agama.png') }} alt="">
                            </a> 
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col lg:flex-row justify-center gap-[23px] rounded-lg">
                    ...
                    <div class="relative">
                        <div class="">
                            <a href="/adminNilai">
                                <img class="w-72 opacity-1 hover:opacity-[0.6] cursor-pointer" src={{ asset('assets/buku-ipa.png') }} alt="">
                            </a> 
                        </div>
                    ...
                    <div class="relative">
                        <div class=""> 
                            <a href="/adminNilai">
                                <img class="w-72 opacity-1 hover:opacity-[0.6] cursor-pointer" src={{ asset('assets/buku-diriku.png') }} alt="">
                            </a> 
                        </div>
                    ...
                    <div class="relative">
                        <div>
                            <a href="/adminNilai">
                                <img class="w-72 opacity-1 hover:opacity-[0.6] cursor-pointer" src={{ asset('assets/buku-lingkungan.png') }} alt="">
                            </a> 
                        </div>
                    </div>
                </div>
