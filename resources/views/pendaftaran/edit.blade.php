    ...
    <div class="bg-white dark:bg-gray-800 shadow">
        <div class="flex justify-center  max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <div class="flex justify-center ">
                <h2 class=" text-gray-800 leading-tight font-bold text-2xl">
    ...
    <div class="py-12 bg-slate-100">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="py-4 px-4 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <form class="container mx-auto px-4 text-black" action="{{ url('update-pendaftaran/'.$pendaftaran->id) }}" method="POST">
                    @csrf
                    @method('PUT')

                    <div>
                        <x-input-label class="text-black" for="name" :value="__('Nama Lengkap')" />
                        <x-text-input id="name" class="block mt-1 w-full" type="text" name="name"
                            :value="$pendaftaran->name" autofocus />

                    </div>

                    <div class="flex flex-col gap-4 pt-6">
                        <x-input-label class="text-black" for="name" :value="__('Jenis Kelamin')" />
                    ...
                    <div class="py-6">
                        ...
                        <x-text-input id="phone" class="block mt-1 w-full" type="text" name="phone"
                            :value="$pendaftaran->phone" autofocus />
                    </div>

                    <div>
                        <x-input-label class="text-black" for="email" :value="__('Alamat Email')" />
                        <x-text-input id="email" class="block mt-1 w-full" type="email" name="email"
                            :value="$pendaftaran->email" autofocus />
                    </div>
                    ...
                    <div class="pt-6">
                        <x-input-label class="text-black" for="tempat_lahir" :value="__('Tempat Lahir')" />
                        <x-text-input id="tempat_lahir" class="block mt-1 w-full" type="text" name="tempat_lahir"
                            :value="$pendaftaran->tempat_lahir" autofocus />
                    </div>
                    ...
                    <div class="pt-6">
                        <x-input-label class="text-black" for="nik" :value="__('NIK')" />
                        <x-text-input id="nik" class="block mt-1 w-full" type="text" name="nik"
                            :value="$pendaftaran->nik" autofocus />
                    </div>
